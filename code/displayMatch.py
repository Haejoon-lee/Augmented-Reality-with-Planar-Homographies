...
if __name__ == "__main__":
    ...
    image1 = Image.open('../data/cv_cover.jpg').convert("RGB")  
    image1 = np.array(image1).astype(np.float32) / 255 #normalize

    image2 = Image.open('../data/cv_desk.png').convert("RGB")  
    image2 = np.array(image2).astype(np.float32) / 255 #normalize
